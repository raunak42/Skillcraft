  ...
  return (
    ...
    >
      <div className=" flex flex-row items-center justify-between p-2">
        ...
        >
          {!isLoading && (
            <img className=" size-8 rounded-full" src="/cross.svg"></img>
          )}
          {isLoading && (
            <img
      ...
      >
        <a
          href="/create"
          className="shrink-0 text-nowrap flex flex-row items-center gap-4 hover:bg-gray-200 p-4 hover:cursor-pointer"
        >

...
export const ModalContent: React.FC<ModalContentProps> = ({ session, user }) => {
  ...
  return (
    <div>
      ...
      {displaModal && (
        ...
        >
          <div className="w-[90%] sm:w-[400px] h-[260px] rounded-xl bg-white flex flex-col items-center justify-between p-6 border-[1.5px] border-black">
